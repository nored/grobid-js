// TEI vs TEI comparator. For each paper in fixtures/blind-corpus/, load the
// grobid-js output (fixtures/blind-corpus/grobid-js/) and the upstream output
// (fixtures/blind-corpus/upstream/) and score four dimensions:
//
...
const reportPath = path.join(here, "bench-report-blind.md");
...
skipIfMissing("bench-blind: compare grobid-js vs upstream", () => {
