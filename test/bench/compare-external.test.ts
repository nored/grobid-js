// TEI vs TEI comparator. For each paper in fixtures/external-corpus/, load the
// grobid-js output (fixtures/external-corpus/grobid-js/) and the upstream output
// (fixtures/external-corpus/upstream/) and score four dimensions:
//
...
const reportPath = path.join(here, "bench-report-external.md");
...
skipIfMissing("bench-external: compare grobid-js vs upstream", () => {
