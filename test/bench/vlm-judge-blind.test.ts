// Thin vitest wrapper around vlm-judge-blind.ts: regenerates the report on test
// invocation so re-runs against fresh TEIs are one `npm test -- vlm-judge`
// away. The report itself is committed under test/bench/vlm-judge-report-blind.md.
...
import { runVlmJudge, writeReport } from "./vlm-judge-blind.js";
